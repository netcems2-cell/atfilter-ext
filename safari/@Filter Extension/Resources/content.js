(function() {
  ...
  browser.storage.local.get(['session_id', 'telemetry_enabled', 'consent_given', 'data_collection_active']).then((result) => {
  ...
  function init() {
    browser.storage.local.get(['filterKeywords', 'consent_given', 'data_collection_active']).then((result) => {
      extensionActive = result.consent_given === true && result.data_collection_active !== false;
